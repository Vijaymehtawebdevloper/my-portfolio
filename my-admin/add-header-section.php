                    ...
                    <div class="row">
                        <div class=" col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="main-title" class="form-control" id="main-title" placeholder="Main-Title">
                            </div>
                            <div class="form-group">
                                <label for="sub-title">Sub-Title</label>
                                <input type="text" name="Sub-Title" class="form-control" id="Sub-Title" placeholder="Sub-Title">
                            </div>
                        </div>
                        <!-- col-left -->
                        <div class="col-md-6 col-sm-12">
